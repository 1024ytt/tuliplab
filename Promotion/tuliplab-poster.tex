...
%				\vspace{-20pt}
		...
		\block[titleleft]{Awards}
		{
			\begin{minipage}[l]{0.75\linewidth}
				...
				\scalebox{1}{
					\footnotesize
					\begin{tabular}{ >{\centering}p{0.12\linewidth}  | p{0.57\linewidth} | p{0.18\linewidth}   r }
						%						>{\raggedleft}
						\toprule
...
%				\vspace{-10pt}
			...
			\begin{minipage}{\linewidth}
				...
				\begin{figure}[H]
					\begin{minipage}{\linewidth}
						\subfigure
						{
							\includegraphics[width=0.86\textwidth]{figures//awards//TULIPAwards2018A.eps}
						}
					\end{minipage}
					...
					\begin{minipage}{\linewidth}
						\subfigure
						{
							\includegraphics[width=0.86\textwidth]{figures//awards//TULIPAwards2016A.eps}
						}
					\end{minipage}
				...
				\begin{minipage}{\linewidth}
					\begin{figure}[H]
						\begin{minipage}{\linewidth}
							\subfigure
							{
								\includegraphics[width=0.93\textwidth]{figures//awards//TULIPAwards2016B.eps}
							}
						\end{minipage}
						...
						\begin{minipage}{\linewidth}
							\subfigure
							{
								\includegraphics[width=0.93\textwidth]{figures//awards//TULIPAwards2018B.eps}
							}
						\end{minipage}
					\end{figure}	
				\end{minipage}	
	...
	\centering
	\note[targetoffsetx=-12.7cm, targetoffsety=-17.8cm,rotate=0, angle=180,radius=8cm,width=.97\textwidth,innersep=.4cm]
	{		
