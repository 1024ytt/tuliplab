...
%%==========================================================================================
%%
\begin{slide}{Membership Rights}
	\begin{table}[htp]
		\caption{The requirements and rights of members at different stages}
		\begin{center}
			\begin{threeparttable}
				\begin{tabular}{c|c|c|c|c}
					\toprule
					 & \textbf{Flipper} & \textbf{Trainee} & \textbf{Infinity}  & \textbf{Alumni}\\ \midrule
					DingTalk & Y & Y & Y & Y\\
					Academy Email & N & Y & Y & Y\\
					Seminar Attendance & C & Y & Y & N\\
					Seminar Presentation & N & I & Y & I\\
					Seminar Q?	 & N & C & Y & Y\\
					Reading Team & Y & Y & I & I \\
					Admin Permissin	 &   &   & Y & Y\\
					ID Hiding	 &   &   & Y & Y\\
					Blog Subdomain Name &   &   & Y & Y\\
					 \bottomrule
				\end{tabular}
				\begin{tablenotes}
					\item[1] C: Compulsory ; \item[2] I: Invitation
				\end{tablenotes}
			\end{threeparttable}
		\end{center}
	\end{table}
