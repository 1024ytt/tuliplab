...
\begin{slide}[toc=,bm=]{Rules in Tulip Lab}
	\begin{itemize}
		\item The full paper should be completed before the deadline of the target conference, and we need finish the following in a month
			\begin{itemize}
				\item In Tulip Lab, tools like Turnitin are recommended to detect plagiarism.
				\item All reviewers of FLIP (07) in Tulip Lab are required to review the paper, and then compare their comments with that of experts after external reviewing. 
				\item Submitting the paper after confirmation of the director.		
			\end{itemize}
	\end{itemize}
\end{slide}
