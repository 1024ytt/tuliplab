...
\begin{itemize}
  ...
  \item \textcolor{orange}{\textit{Code in TULIP}}
    \begin{itemize}
      \item \textit{Open-code}: \url{https://github.com/tulip-lab/open-code}
    \end{itemize}
  \item \textcolor{orange}{\textit{Data in TULIP}}
  \begin{itemize}
    \item \textit{Open-data}: \url{https://github.com/tulip-lab/open-data}
  \end{itemize}
\end{itemize}
