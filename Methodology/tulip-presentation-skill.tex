...
\smartdiagram[descriptive diagram]{
  {powerdot-tuliplab.sty,{TULIP-Lab Style File}},
  {tuliplab-P00.tex, {A Simple Presentation Sample with Transitions}},
  {tuliplab-P01.tex,One Academic Presentation Sample with References List},
  {tuliplab-P03.tex,One Sample file with PSTrick figures.},
  {logos/tulip,	Folder of images for slides graphics.}}
\end{center}
\end{slide}
...
\begin{description}
  \item[Installation] Typically this package should be installed automatically with a full \LaTeX\ package,
      ...
      \begin{itemize}
        \item Copy files the whole folder powerdot-tuliplab to your home directory under ~/texmf/tex/latex/powerdot-tuliplab
...
The \textit{gitinfo2} package contains a gitinfo folder
with three executive bash shell scripts:
post-checkout,post-commit and post-merge.
\begin{itemize}
...
and it should generate/update the file ./git/gitHeadInfo.gin 
in your local repository.
\item Compile the main \LaTeX\ file, and view the PDF.
\end{itemize}
\end{slide}

%\begin{slide}{\LaTeX\ Rules}
%\begin{itemize}
%  \item 
%  \item 
%  \item 
...
\section{What to say \& How to say it}
\begin{slide}[toc=,bm=]{What to say and how to say it}
...
\begin{itemize}
  ...
  \item Don't get \textcolor{orange}{Bogged Down in Details}\\
...
\begin{itemize}
  ...
  \item Use an \textcolor{orange}{Organized Approach}\\
...
\begin{itemize}
  ...
  \item Don't \textcolor{orange}{Inflict Pain} on the Audience\\
  ...
  \item Have a \textcolor{orange}{Purpose and Conclusion}\\
...
\begin{itemize}
  ...
  \item Indicate that your Talk is \textcolor{orange}{Over}\\
...
\item \textcolor{orange}{Control Your Voice}\\
  ...
  \item Don't Start Your \textcolor{orange}{Talk with an Apology}\\
...
\begin{description}
  \item[Genuine request] It should cause you no difficulties if you are adequately prepared.\pause
